  ...
  render() {
    ...
    return (
      <div className="kpis">
        ...
        <KPI className='est-cost' header='Costos Estimados' value={'$' + numWithCommas(estCost.toFixed(0))} unit=' MXN'/>
        <KPI className='cost' header='Costos Reales' value={'$' + numWithCommas(cost.toFixed(0))} unit=' MXN'/>
