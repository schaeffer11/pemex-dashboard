...
@autobind class executiveUI extends Component {
  ...
  buildExecTableExport(data, groupBy) {
    ...
    newRow = newRow.concat([
      ...
      'Total Gel de Fractura (m3)',
      'Total Gel de Lineal (m3)',
      'Total Modificador Permeabilidad (m3)',
      'Total Espaciador (m3)',
  ...
  render() {
    ...
    execTableData = execTableData.map(i => {
        ...
        return {
            ...
            gelLineal: volumen ? volumen.TOTAL_GEL_LINEAL : undefined,
            modificadorPermeabilidad: volumen ? volumen.TOTAL_MODIFICADOR_PERMEABILIDAD : undefined,
            espaciador: volumen ? volumen.TOTAL_ESPACIADOR : undefined,
    ...
    return (
      <div className="data executive">
        <div className='content'>
          <TimeSlider />
          <div>
            <LocalModal title="Filtros" isFilter id="executiveFilters">
              <Filters />
            </LocalModal>
