  ...
  makeCedulaForm() {
    return (
      <div className='cedula-form' >
        ...
        <InputRowUnitless header="Tipo de apuntalante" name='' />
        <InputRow header="Concentraci on de apuntalante" name='' unit='lbm/gal' />
        ...
        <InputRow header="Vol. Liquid Acum." name='' unit='m3' />
  ...
  makeDetallesForm() {
    return (
      <div className='detalles-form' >
        ...
        <InputRow header="Volumen Precolchon (gel lineal o N2)" name='' unit='m3' />
        ...
        <InputRow header="Volumen Desplazamiento gel lineal" name='' unit='m3' />
      </div>
    )
  }
