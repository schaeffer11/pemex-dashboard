    ...
    return (
      <div className='fisico-form' >
        <div className="input-table">
          ...
          <InputRow header="Densidad del aceite" name='densityAceite' value={pruebasDeLaboratorioData[index].densityAceite} onChange={this.updateValue} index={index} unit={<div>g/cm<sup>3</sup></div>} errors={this.state.errors} onBlur={this.validate} />
          <InputRow header="Densidad del agua" name='densityAgua' value={pruebasDeLaboratorioData[index].densityAgua} onChange={this.updateValue} index={index} unit={<div>g/cm<sup>3</sup></div>} errors={this.state.errors} onBlur={this.validate} />
          <InputRow header="Densidad de la emulsión" name='densityEmulsion' value={pruebasDeLaboratorioData[index].densityEmulsion} onChange={this.updateValue} index={index} unit={<div>g/cm<sup>3</sup></div>} errors={this.state.errors} onBlur={this.validate} />
